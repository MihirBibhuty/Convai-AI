...
export function ExplorerModel(props) {
  const group = useRef()
  ...
  useEffect(() => {
    ...
    var from = props.dance ? 'Armature|mixamo.com|Layer0.005' : 'Armature|mixamo.com|Layer0';
    var to = props.dance ? 'Armature|mixamo.com|Layer0' : 'Armature|mixamo.com|Layer0.004';
    if (actions[from]?.isRunning()) {
      actions[from].fadeOut(0.3);
    }
  ...
  useEffect(() => {
    ...
    var from = props.jump ? 'Armature|mixamo.com|Layer0.005' : 'Armature|mixamo.com|Layer0';
    var to = props.jump ? 'Armature|mixamo.com|Layer0' : 'Armature|mixamo.com|Layer0.004';
    if (actions[from]?.isRunning()) {
      actions[from].fadeOut(0.3);
    }
    if (actions[to]) { // Add null check
  ...
  useEffect(() => {
    ...
    var from = props.punch ? 'Armature|mixamo.com|Layer0.005' : 'Armature|mixamo.com|Layer0';
    var to = props.punch ? 'Armature|mixamo.com|Layer0' : 'Armature|mixamo.com|Layer0.004';
    if (actions[from]?.isRunning()) {
      actions[from].fadeOut(0.3);
    }
    if (actions[to]) { // Add null check
  ...
  useEffect(() => {
    ...
    var from = props.kick ? 'Armature|mixamo.com|Layer0.005' : 'Armature|mixamo.com|Layer0';
    var to = props.kick ? 'Armature|mixamo.com|Layer0' : 'Armature|mixamo.com|Layer0.004';
    if (actions[from]?.isRunning()) {
      actions[from].fadeOut(0.3);
    }
    if (actions[to]) { // Add null check
  ...
  useEffect(() => {
    ...
    var from = props.special ? 'Armature|mixamo.com|Layer0.005' : 'Armature|mixamo.com|Layer0';
    var to = props.special ? 'Armature|mixamo.com|Layer0' : 'Armature|mixamo.com|Layer0.004';
    if (actions[from]?.isRunning()) {
      actions[from].fadeOut(0.3);
    }
    if (actions[to]) { // Add null check
